...
# Bloxorz game's terrain is represented as a Map using 0 (void spaces),
# 1 (tile) and 9 (goal state)

# Read terrain or Map from Map/Map.txt file (level -1 of game) along with
# user provided start position (x-y co-ordinates) for the agent or block

# Display terrain and start position of the agent
...
print("Agent solves Bloxorz game search problem using BFS strategy")
BFS(block)